class apb_base_test extends uvm_test;
  ...
  function void build_phase(uvm_phase phase);
    ...
    cfg = apb_configuration::type_id::create("cfg");
    if (!uvm_config_db #(virtual apb_if)::get(this, "", "vif", cfg.vif))
      `uvm_fatal("APB_VIF", "Virtual APB interface was not supplied by testbench")

    configure();
    void'($value$plusargs("NUM_ITEMS=%d", num_items));
    uvm_config_db #(apb_configuration)::set(this, "env.agent", "cfg", cfg);
